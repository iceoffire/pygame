...
def load():
    ...
    game_object['list'].append(PowerUp(var['folder']+'/assets/powerUP/underwear.png', 'Tamanho da cueca', 30, 1.1, 1, 1))
    return True, {
    ...
    for e in pygame.event.get():
        ...
        if e.type == MOUSEBUTTONDOWN and e.button == 1:
            ...
            if verificar_click(settings['game_object']['bandeira'][0], pos):
                ...
                settings['game_object']['nota'].append(Sprite(pos[0], pos[1], settings['var']['folder'] + '/assets/notas/nota' + str(settings['var']['valor_nota'])+'.png', 68, 30))
